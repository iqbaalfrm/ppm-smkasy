          ...
          <section class="py-4 py-md-5 py-xl-8">
            <div class="container-fluid overflow-hidden">
              <div class="row gy-4 gy-lg-0 justify-content-xl-between">
                ...
                <div class="col-12 col-md-4 col-lg-3 col-xl-2">
                  <div class="widget">
                    <h4 class="widget-title mb-4">Menu Utama</h4>
                    <ul class="list-unstyled">
                      <li class="mb-2">
                        <a href="#!" class="link-secondary text-decoration-none">Beranda</a>
                      </li>
                      <li class="mb-2">
                        <a href="#!" class="link-secondary text-decoration-none">Tentang Kami</a>
                      </li>
                      <li class="mb-2">
                        <a href="#!" class="link-secondary text-decoration-none">Prestasi</a>
                      </li>
                      <li class="mb-2">
                        <a href="#!" class="link-secondary text-decoration-none">Berita</a>
                      </li>
                      <li class="mb-0">
              ...
              <div class="row gy-4 gy-md-0">
                <div class="col-xs-12 col-md-7 order-1 order-md-0">
                  ...
                  <div class="credits text-secondary text-center text-md-start mt-2 fs-7">
                    Built by <a href="https://bootstrapbrain.com/" class="link-secondary text-decoration-none">PPM</a> with <span class="text-primary">&#9829;</span>
                  </div>
                </div>
