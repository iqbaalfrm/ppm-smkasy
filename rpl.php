    ...
    >
      <div class="container d-flex align-items-center">
        <h1 class="logo me-auto">
          <a href="index.html">
            <img src="assets/img/logo.png" alt="" class="img-fluid" /> SMK
            ASY-SYAMSURIYYAH
          </a>
        </h1>
          ...
          <ul>
            ...
            <li class="dropdown">
              ...
              <ul>
                ...
                <li><a href="visim.html">Visi & Misi</a></li>
            ...
            <li>
              <a class="nav-link scrollto" href="#footer">Hubungi Kami</a>
            </li>
            <li>
              <a
                class="nav-link scrollto"
                href="https://drive.google.com/file/d/1331Tf_pzDFVNqXLu-YC7niMCGpIU8ymL/view?usp=sharing"
                >PPDB</a
              >
            </li>
          </ul>
